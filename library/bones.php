  ...
  if (!is_admin()) {
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		*/
		...
		/* Loading Jquery from external CDN with local fallback */
		    ...
		    if($test_url !== false) { 
		        ...
		        function load_local_jQuery() {
		            wp_deregister_script('jquery'); 
		            wp_register_script('jquery', get_bloginfo('template_url').'/js/jquery-1.12.4.js', __FILE__, false, '1.12.4', true); 
		            wp_enqueue_script('jquery'); 
		        }
